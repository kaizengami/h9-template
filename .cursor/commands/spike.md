...
5. Print the next command for the user to run, exactly:
   ...
   Open in a new tmux pane with a fresh Cursor window:

       tmux split-window -h -c "../hack9-$1" "cursor ."
...
Do **not** open the new Cursor window yourself. The user runs the tmux
command so they keep control of pane layout and which workspace is in
focus.
