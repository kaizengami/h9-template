...
description: Install and integrate shadcn/ui components correctly. Use whenever adding a new UI primitive (button, dialog, select, command palette, sonner, etc.) under components/ or app/. Covers the exact npx command, where components land, and how to wrap for behavior changes.
---
...
[.cursor/rules/020-shadcn-ui.mdc](../../rules/020-shadcn-ui.mdc).
