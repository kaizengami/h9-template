---
description: Investigate a symptom and produce ranked hypotheses with evidence. Read-only — no fixes. Mirrors the @bug-hunter subagent run from the Cursor primary.
---
