---
description: Add Vitest unit tests and Playwright E2E tests for changed code. Mirrors the @test-writer subagent in Claude Code.
---
...
6. Stage the changes with `git add` and commit with
   ...
   does that manually in their Claude Code session when the rate
   limit clears.
