...
Repro-first methodology, codified. Per Anthropic's "give Claude a way
to verify its work" guidance, a confirmed-failing test is the cheapest
way to know when the bug is fixed. This skill writes that test before
anyone touches the production code.
