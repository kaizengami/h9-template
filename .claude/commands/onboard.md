...
allowed-tools: Read, Glob, Grep, Write, Bash(git:*), Bash(ls:*), Bash(cat:*), Bash(find:*), Bash(jq:*), Bash(rg:*), Bash(gh:*), Bash(bash:*)
---
...
2. Read any existing `CLAUDE.md`/`AGENTS.md`/README.
